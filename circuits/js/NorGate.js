...
*	Class:		NorGate.js
*
*	Behavior:	This class represents the functionality of an NOR gate. The class contains
...
function NorGate(initX, initY, setName, id, setup) {
	...
	function setPlugoutWire(line) {
		plugoutWire = line;
		if (plugin1Val == 0 || plugin2Val == 0) plugoutWire.setStroke("red");
	...
	// evaluate this gate; NOR the two values in pluginVals, and send the output to the next component
	function evaluate() {
		if (plugin1Val != -1 && plugin2Val != -1) {
			var res = 0;
			if (plugin1Val == 0 && plugin2Val == 0) {
				res = 1;
			}
	...
	function setPlugoutWireColor() {
		if (plugin1Val == 0 && plugin2Val == 0) { plugout.setStroke("red"); plugoutWire.setStroke("red"); gateShape.setFill("red"); gateShapeCircle.setFill("red"); }
		else { plugout.setStroke("blue"); plugoutWire.setStroke("blue"); gateShape.setFill("blue"); gateShapeCircle.setFill("blue"); }
	}
}
