...
function AndGate3(initX, initY, setName, id, setup) {
	...
	function evaluate() {
		if (plugin1Val != -1 && plugin2Val != -1 && plugin3Val != -1) {
			var res = 0;
			if (plugin1Val == 1 && plugin2Val == 1 && plugin3Val == 1) res = 1;
